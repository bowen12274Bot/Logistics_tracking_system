...
- 舊入口（stubs）：
  ...
  - 服務標準/原則（舊入口）：`docs/delivery_service_standards.md`（文件：`docs/architecture/delivery-service-standards.md`）
- 流程圖（概念流程）：`docs/design/sequence-diagrams.md`（舊入口：`docs/sequence-diagrams.md`）

### L3：API 參考

- 參考索引：`docs/reference/README.md`
- API 參考（接口參考）：`docs/reference/api.md`
- API 參考分頁索引：`docs/reference/api/README.md`
- API 契約索引（入口）：`docs/api-contract.md`
...
- Cargo Module（UML）→ `docs/reference/api/03-packages.md`、`docs/reference/api/04-map-routing.md`、`docs/reference/api/07-exceptions-tasks.md`（以及車輛/任務/倉儲作業相關模組文件）
...
- API/規則分離：`docs/api-contract.md` 作為索引入口；接口與 schema 放在 `docs/reference/api/`；規則集中到模組文件（exceptions/operations/tracking/payment…）

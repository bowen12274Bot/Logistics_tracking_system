...
本資料夾是 `docs/architecture/`（L1 概念層）的入口：只放「不易過期」的系統概念、不變量（invariants）、責任邊界、以及核心名詞定義。

> 規則/流程權威：`docs/modules/README.md`；接口參考：`docs/reference/api/README.md`；端到端用例：`docs/features/README.md`

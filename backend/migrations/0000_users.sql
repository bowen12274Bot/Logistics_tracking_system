...
INSERT OR IGNORE INTO users (id, user_name, phone_number, address, email, password_hash, user_type, user_class, billing_preference) VALUES
  ('user-cust-1', '示範合約客戶', '0912345678', '台北市信義區市府路 1 號', 'cust@example.com', '4f21b18a4c743a5da01bb3a4955dea0a0294a0b4f7977b454c7259e37b2e6c19', 'customer', 'contract_customer', 'monthly'), -- 密碼: cust123
  ('user-cust-2', '示範非合約客戶', '0912999888', '台北市測試區測試路 1 號', 'noncontract@example.com', 'f1e8f488e212210b3f1b6835535c8b79b13c8e5e96f754827949e1782717ebb4', 'customer', 'non_contract_customer', NULL), -- 密碼: custnc123

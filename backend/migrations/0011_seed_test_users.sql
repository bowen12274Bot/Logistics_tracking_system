...
INSERT OR IGNORE INTO users (id, user_name, phone_number, address, email, password_hash, user_type, user_class, billing_preference) VALUES
  ('user-cust-1', '示範合約客戶', '0912345678', 'END_HOME_1', 'cust@example.com', '4f21b18a4c743a5da01bb3a4955dea0a0294a0b4f7977b454c7259e37b2e6c19', 'customer', 'contract_customer', 'monthly'),
  ('user-cust-2', '示範非合約客戶', '0912999888', 'END_HOME_2', 'noncontract@example.com', 'f1e8f488e212210b3f1b6835535c8b79b13c8e5e96f754827949e1782717ebb4', 'customer', 'non_contract_customer', NULL);

-- HUB_0 的預設員工（用於測試/文件）
INSERT OR IGNORE INTO users (id, user_name, phone_number, address, email, password_hash, user_type, user_class, billing_preference) VALUES
  ('user-driver-0', '示範司機', '0911222333', 'HUB_0', 'driver@example.com', '494d022492052a06f8f81949639a1d148c1051fa3d4e4688fbd96efe649cd382', 'employee', 'driver', NULL),
  ('user-warehouse-0', '倉儲人員', '0911777888', 'REG_0', 'warehouse@example.com', '0e842cbe0341154ee33e0ed3bc18282cd69e016a8d56fda05ec92e7ff20a0f31', 'employee', 'warehouse_staff', NULL),
...
SELECT
  ...
  NULL
FROM nodes n
WHERE n.id LIKE 'REG_%' AND n.id <> 'REG_0';
